...
const ListingPropertyResult: React.FC<ListingPropertyResultProps> = () => {
    ...
    return <div className={`flex md:justify-end justify-center ${isMobile && isMapMode && '!justify-end'}`}>
        <div className={`w-[78%] pl-[1.5rem] py-[3rem] ${isMobile && isMapMode && '!p-0 w-[95%]'}`}>
            {
                isMapMode ? <>
                    ...
                    <div className="md:overflow-x-visible overflow-hidden grid md:grid-cols-4 grid-cols-2 gap-5">
                        {
                            propertyMapped
                        }
                    </div>
